...
//    urlss.remove(url);
  ...
  public Report doTests(Cucumblan cucumblan)
    ...
    String target = "http://35.193.57.60/"+testId.toString() + "/feature/virtualan-contract.0.feature";
     ...
     * */
    String linkReport = "http://35.193.57.60/"+testId.toString() + "/cucumber-html-reports/overview-features.html";
